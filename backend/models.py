...
class OrderItem(Base):
    ...
    # ⚠️ 2026-09-07: Integer -> Float. Tarozi mahsulotlari (kg/g/l) kasrli
    # miqdorda sotiladi: 0.740 kg. Integer bo'lganda API 422 qaytarardi va
    # "og'irlik oynasi" (pos.js) yuborgan qiymat serverga umuman o'tmasdi.
    # `ml` sotuvi shu paytgacha ishlab turgani ADASHTIRMASIN — u faqat ml
    # miqdorlari butun son (30, 50) bo'lgani uchun int filtridan o'tib
    # ketardi. Migratsiya: b3d7f1c92a48.
